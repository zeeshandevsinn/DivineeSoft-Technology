...
const TECH_BADGES = [
  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-[#f5f7fb] text-[#0b0e14] dark:bg-[#030712] dark:text-white py-24 flex items-center justify-center transition-colors duration-300">
      ...
      <div className="pointer-events-none absolute -left-20 top-20 h-100 w-100 rounded-full bg-primary/5 dark:bg-primary/10 blur-3xl opacity-60" />
      <div className="pointer-events-none absolute -right-20 bottom-10 h-125 w-125 rounded-full bg-blue-600/5 dark:bg-blue-600/10 blur-3xl opacity-50" />
      ...
      <div className="container relative mx-auto px-6 z-10">
        <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
          ...
          <motion.div
            initial="hidden"
            animate="visible"
            className="flex flex-col text-left max-w-170"
          >
            {/* Badge / Chip */}
            <motion.div
              variants={fadeUp}
            ...
            <motion.p
              variants={fadeUp}
              custom={3}
              className="text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-145 mb-10"
            >
